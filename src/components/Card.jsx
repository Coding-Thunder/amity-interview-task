...
const Card = ({ text, title, icon: Icon }) => {
    return (
        <div
            ...
            <div class="relative z-10 mx-auto max-w-md">
                ...
                <div
                    ...
                    <p>{text || "Perfect for learning how the framework works, prototyping a new idea, or creating a demo to share online"}</p>
                </div>
                <div class="pt-5 text-base font-semibold leading-7">
                    <p>
                        <a href="#" class="text-sky-500 transition-all duration-300 group-hover:text-white">{title || "Read the docs"}
                            &rarr;
                        </a>
                    </p>
                </div>
